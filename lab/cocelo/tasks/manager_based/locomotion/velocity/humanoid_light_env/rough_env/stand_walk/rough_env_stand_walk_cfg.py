...
class HumanoidRewardsCfg:
    ...
    # Penalize joint limits (hip/ankle 위주)
    ...
    # elbow는 자산에 따라 1DOF/2DOF가 섞일 수 있어서 안전하게 패턴 처리
    ...
    # torso_joint 없음 -> torso_yaw/pitch/roll 전체를 패턴으로
    ...
    # joint_vel_l2 = RewTerm(func=mdp.joint_vel_l2, weight=-5.0e-5,
    #                        params={"asset_cfg": SceneEntityCfg("robot", joint_names=[".*_joint"])})
...
class HumanoidRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # humanoid_light 기준 torso_roll_link 사용
        self.events.add_base_mass.params["asset_cfg"].body_names = ["torso_roll_link"]
