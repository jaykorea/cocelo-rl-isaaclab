...
class MySceneCfg(InteractiveSceneCfg):
    ...
    height_scanner = RayCasterCfg(
        ...
        offset=RayCasterCfg.OffsetCfg(pos=(0.0, 0.0, 20.0)),
        ray_alignment="yaw",
        pattern_cfg=patterns.GridPatternCfg(resolution=0.05, size=[1.55, 1.05]),
        debug_vis=True,
        mesh_prim_paths=["/World/ground"],
    )

    left_mask_sensor = None
    right_mask_sensor = None
        ...
        contact_forces = ObsTerm(
            ...
            params={
                "sensor_cfg": SceneEntityCfg(
                    "contact_forces",
                    body_names=["FL_wheel_link", "FR_wheel_link", "RL_wheel_link", "RR_wheel_link"],
                )
            },
        )
...
class EventCfg:
    ...
    randomize_rigid_body_inertia = None
